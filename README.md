# MAGICIAN Learning By Demonstration Multicamera Tracking
...
Camera placement and field-of-view coverage is planned with `camera_field_of_view_calculator.py`, which produces a top-down layout diagram:

![Camera layout — one side](doc/camera_layout_one_side.png)
...
python3 tracker.py /path/to/video.mp4 --calib calibration/gopro13_5.3k.calib

# Track from a live camera (device 0)
python3 tracker.py 0 --calib calibration/gopro13_5.3k.calib --marker-lengths 1=0.06,13=0.06,42=0.06
...
|---|---|---|
| `calibration/gopro13_5.3k.calib` | GoPro Hero 13 | 5312x2988 |
| `calibration/gopro4_2.7k.calib` | GoPro Hero 4 | 2704x1520 |
...
python3 tracker.py recording.mp4 \
  --calib calibration/gopro13_5.3k.calib \
...
├── plot_csv.py                     # 3D trajectory visualization
├── camera_field_of_view_calculator.py  # Camera layout / FOV planner
...
├── doc/
│   ├── camera_layout_one_side.png  # FOV layout diagram
│   ├── d7000.jpg                   # NIKON D7000 tracking result
│   ├── d7500.jpg                   # NIKON D7500 tracking result
│   ├── hero4.jpg                   # GoPro Hero 4 tracking result
│   ├── hero13.jpg                  # GoPro Hero 13 tracking result
│   └── forces.jpg                  # ATI force/torque recording
